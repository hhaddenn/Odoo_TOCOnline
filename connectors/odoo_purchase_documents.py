...
class OdooPurchaseDocumentsConnector:
    """Lê faturas de compra do Odoo."""
    ...
    def get_purchase_documents(self, limit=200, company_id=None):
        """Devolve faturas de compra do Odoo."""
